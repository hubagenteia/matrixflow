# 🤖 Protocolo de Agentes: MatrixFlow
...
- **Regra:** Não utilize comentários extensos no código para explicar decisões
  arquiteturais.
- **Ação:** Registre todas as mudanças importantes e seus "porquês" no arquivo [DECISIONS.md](file:///d:/Projetos/Hub-Agente-IA/matrixflow/DECISIONS.md).
